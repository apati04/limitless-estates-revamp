...
const steps = ['Basic Information', 'Investor Information', 'Review and Submit'];
					...
					<React.Fragment>
						{activeStep === steps.length ? (
							<React.Fragment>
								...
								<Typography variant="subtitle1">end of form subtitle</Typography>
							</React.Fragment>
						) : (
							<React.Fragment>
								...
								<div className={classes.buttons}>
									{activeStep !== 0 && (
										<Button onClick={this._handleBack} className={classes.button}>
											Back
										</Button>
									)}
								</div>
