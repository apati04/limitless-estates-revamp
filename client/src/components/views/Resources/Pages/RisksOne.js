...
function RisksOne(props) {
        ...
        return (
          <Card key={index} className={classes.cardStyle}>
            <div className={classes.gridItem}>
              ...
              <Typography className={classes.subTitleText}>Page 1 of 2</Typography>
            </div>
            <CardContent>
  ...
  return (
    <div className={classes.root}>
      ...
      <Grid container justify='space-evenly' alignItems='center' wrap='wrap' className={classes.cardBodyGrid}>
        ...
        <Grid item lg={9} md={10} xs={12}>
          <Card className={classes.cardStyle}>
            <CardContent style={{ textAlign: 'right' }}>
              <Button
                variant='contained'
                component={(props) => <Link to='/resources/investing-risks?page=2' {...props} />}
                color='primary'
