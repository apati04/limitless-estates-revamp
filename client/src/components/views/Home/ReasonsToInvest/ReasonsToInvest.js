...
const SectionLink = props => <Link to="/resources/why-invest-in-multifamily" {...props} />;
const styles = theme => ({
	root: {
		minHeight: 20 + 'rem',
		padding: '80px',
		...
		<section className={classes.root}>
			...
			<div className={classes.headerContainer}>
				<Grid container justify="center" alignItems="center" className={classes.gridContainer}>
					<Grid item xs={12}>
						<Typography variant="h2" align="center" paragraph className={classes.headerText}>
				...
				<Grid container justify="flex-end" alignItems="center" spacing={16}>
					...
					<Grid item md={6} xs={12}>
						<div style={{ textAlign: 'center' }}>
							<Hidden smDown>
								<Avatar alt="investment" src={testImage} className={classes.avatar} />
							</Hidden>
