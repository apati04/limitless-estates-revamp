...
const data = {
  text: [
    ...
    "An article for more tips on ways to increase rents (some may not apply to all of our investments) that our team will implement to drive the value of our properties can be found ",
    <Link to="/">here</Link>
  ]
};
export default data;
