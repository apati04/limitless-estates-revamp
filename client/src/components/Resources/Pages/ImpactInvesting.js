      ...
      <Grid container>
        <Grid item>
          <Typography component="p" variant="body1">
            Impact Investing is simply investing with a purpose. Often called a
            “double bottom line” investment, impact investing enables investors
            to put their money to good use in meaningful, intelligent ventures
            that provide both a financial AND a social return on their
            investment. This sector of investing has never been more important
            than it is now. The good news is that those who believe in the value
            and purpose of impact investing can still obtain solid, financial
            returns in the process.", "Foundations and the ultra-wealthy have
            long been participants in impact investing, and only recently has
            this concept come into favor with everyday investors who want to
            make a difference and a return with their investment dollars.
            Opportunities to make a difference exist in housing, microfinance,
            healthcare, energy, food and agriculture targeted into emerging
            nations and here at home. Measuring financial returns is easier and
            much more scientific than the new metric of measuring the social
            and/or environmental impact claims of an investment. This is much
            more challenging as some social and environmental returns of an
            investment can take years to quantify. As such, investors are
            exercising more and more scrutiny over these returns. This will be a
            very important topic to watch as the sector unfolds.
          </Typography>
        </Grid>
      </Grid>
    </div>
