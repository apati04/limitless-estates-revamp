...
const data = [
  ...
  },
  {
    ...
    body: [
      <span key="b0">
        <strong>Hard Assets in Real Estate: </strong>The value of real estate.
        Commercial property is a unique investment class when compared to other
        hard assets in that not only does it typically preserve its value during
        periods of inflation, but leased commercial property can also be an
        income producing asset, paying dividends back to investors.
      </span>
    ]
  },
  {
    title: 'Housing is a Necessity',
    body: [
      <span key="house-0">
        Houses, fundamentally, are just aggregations of labor and materials —
        the cost approach to valuation. As personal income for most in the labor
        force increases at the rate of consumer inflation plus a value for any
        skill appreciation contributing to their employer’s benefit, over time a
        smaller percentage of that inflating income is spent carrying a home.{' '}
      </span>,
      <span key="house-2">
        Link to full article:{' '}
        <a
          href="https://journal.firsttuesday.us/is-housing-a-luxury-or-necessity/6770/"
          target="_blank"
          rel="noopener noreferrer"
        >
          https://journal.firsttuesday.us/is-housing-a-luxury-or-necessity/
        </a>
      </span>
    ]
  },
